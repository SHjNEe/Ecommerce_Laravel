                ...
                <div class="product-view">
                    ...
                    <div class="mt-2">
                        <div class="input-group">
                            ...
                            <input type="number" min="1" value="<?php echo e($this->quantityCount); ?>" class="input-quantity" />
                            <span class="btn btn1" wire:click="incrementQuantity()"><i class="fa fa-plus"></i></span>
                        </div>
                    </div>
                    <div class="mt-2">
                        <button type="button" class="btn btn1" wire:click="addToCart(<?php echo e($product->id); ?>)"> 
