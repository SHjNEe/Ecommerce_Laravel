    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="colors">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{ url('admin/color') }}">Colors List</li>
            <li class="nav-item"> <a class="nav-link" href="{{ url('admin/color/create') }}">Add Colors</a></li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="sliders">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{ url('admin/slider') }}">Slider List</li>
            <li class="nav-item"> <a class="nav-link" href="{{ url('admin/slider/create') }}">Add Slider</a></li>
          </ul>
        </div>
      </li>
